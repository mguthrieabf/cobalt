...
urlpatterns = [
    ...
    path('create-payment-intent', core.create_manual_payment_intent, name='paymentintent'),
    path('create-payment-superintent', core.create_auto_payment_intent, name='paymentsuperintent'),
